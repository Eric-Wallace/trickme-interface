# Saves the dev questions into a pickle file, which non_qanta server uses.
...
for item in dev_data:
    write_data.append((item.text, item.page))

with open('dev_questions.pickle', 'wb') as handle:
